...
import { formatEventClock } from "@/utils/format-event-date";
...
export const faqItems: FaqItem[] = [
  ...
  },
  {
    ...
    answer: `El registro de asistentes comienza a las ${formatEventClock(site.event.startDateTime)}. Te recomendamos llegar con algo de antelación para realizar la acreditación tranquilamente y estar listo/a para el comienzo de las primeras sesiones.`,
  },
  {
  ...
  },
  {
    ...
    answer: `Si tienes alguna alergia, intolerancia o necesidad alimentaria especial, podrás indicarlo durante el proceso de registro en Eventbrite. Esta opción estará disponible próximamente. Si ya has adquirido tu entrada y no pudiste indicarlo durante el registro, puedes ponerte en contacto con nosotros a través de ${site.contactEmail} para que podamos tenerlo en cuenta.`,
  },
  {
    question: "¿El recinto es accesible para personas con movilidad reducida?",
    answer: `Sí. El ${venue.name} es accesible para personas con movilidad reducida. Si necesitas alguna adaptación o asistencia adicional durante el evento, puedes ponerte en contacto con la organización antes del evento.`,
  },
  {
    question: "Tengo otra duda, ¿cómo puedo contactar con la organización?",
    answer: `Si tu pregunta no aparece aquí, puedes ponerte en contacto con el equipo de GDG Aranjuez a través de ${site.contactEmail}, LinkedIn o enviarnos un mensaje directo por Instagram. Estaremos encantados de ayudarte.`,
  },
];
